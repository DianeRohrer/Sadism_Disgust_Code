...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\rohre\\Local\\Sadism_Disgust_Code\\MoralCondition_lastrun.py',
...
while continueRoutine and routineTimer.getTime() < 0.1:
    ...
    if connecting_message.status == STARTED:
        ...
        if tThisFlipGlobal > connecting_message.tStartRefresh + 0.1-frameTolerance:
