...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\simla\\Documents\\GitHub\\Sadism_Disgust_Code\\MoralCondition_v2_lastrun.py',
...
for thisLoop in loop:
    ...
    # keep track of which components have finished
    OfferComponents = [player_image_offer, player_name_offer, proposed_split, accept_reject, p_port_9, p_port_10]
