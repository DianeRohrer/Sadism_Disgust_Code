...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\simla\\Documents\\GitHub\\Sadism_Disgust_Code\\Gustatory_Condition_v2_lastrun.py',
...
for thisBlocks_of_Tastant in Blocks_of_Tastants:
    ...
    for thisEach_Tastant_Once in Each_Tastant_Once:
        ...
        # keep track of which components have finished
        spit_beepComponents = [spit_text, spit_sound, screen_clear, p_port_9]
        ...
        while continueRoutine and routineTimer.getTime() < 40.0:
            ...
            # *p_port_10* updates
            if p_port_10.status == NOT_STARTED and t >= 6.0-frameTolerance:
                # keep track of start time/frame for later
            ...
            # *p_port_11* updates
            if p_port_11.status == NOT_STARTED and t >= 12.2-frameTolerance:
                # keep track of start time/frame for later
            ...
            # *p_port_12* updates
            if p_port_12.status == NOT_STARTED and t >= 37.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        # keep track of which components have finished
        PalatabilityComponents = [Palatability_Score, p_port_17]
